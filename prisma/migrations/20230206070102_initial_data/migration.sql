-- CreateEnum
CREATE TYPE "Department" AS ENUM ('Engineering', 'Humanities', 'LifeSciences', 'PhysicalSciences', 'SocialSciences');

-- CreateEnum
CREATE TYPE "CareerGoal" AS ENUM ('PreMed', 'PreLaw', 'PreGradSchool');

-- CreateEnum
CREATE TYPE "Duration" AS ENUM ('Quarterly', 'Summer', 'AcademicYear', 'YearRound');
